<x-admin-layout>
    @section('title', 'Messagerie Administrative')
        ...
        <div class="w-80 border-r border-gray-100 flex flex-col">
            ...
            <div class="flex-1 overflow-y-auto custom-scrollbar">
                @forelse($chats as $userId => $chat)
                    <a href="{{ route('admin.messagerie', ['user_id' => $userId]) }}" 
        ...
        <div class="flex-1 flex flex-col bg-gray-50/30">
            @if($activeChat)
                ...
                <div class="p-6 bg-white border-t border-gray-100" x-data="{ fileName: '' }">
                    ...
                    @endif
                    <form action="{{ route('admin.messagerie.store') }}" method="POST" enctype="multipart/form-data" class="flex flex-col space-y-4">
                        @csrf
