...
<head>
    ...
    <title>Récupération de mot de passe - ACPE Reco</title>
        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden anim-up">
            ...
            <div class="bg-acpe-blue border-b-4 border-acpe-orange px-8 py-7 text-center">
                <div class="flex items-center justify-center space-x-3 text-white mb-1">
                    <i class="fa-solid fa-envelope-open-text text-acpe-orange text-lg"></i>
                    <h1 class="text-xl font-bold tracking-wide">Mot de passe oublié ?</h1>
                </div>
                <p class="text-acpe-light text-xs font-medium mt-1">Réinitialisez votre accès en quelques secondes</p>
            </div>
            ...
            <div class="px-8 py-8">
                ...
                <div class="bg-blue-50 border border-blue-100 rounded-xl px-4 py-3.5 mb-6 flex items-start gap-3">
                    ...
                    <p class="text-sm text-acpe-blue leading-relaxed">
                        Aucun problème. Indiquez votre adresse e-mail et nous vous enverrons un lien pour choisir un nouveau mot de passe.
                    </p>
                </div>

                <!-- Session Status (success) -->
                @if (session('status'))
                    <div class="bg-green-50 border border-green-200 text-green-700 text-sm px-4 py-3.5 rounded-xl mb-6 flex items-start gap-2">
